...
│    第一消费者：vitro_cli、scripts/shadow_verify.go（capi 直调，676 个用例的生产验证）
...
- **C 教学子集**：C Shadow Verification **676 个用例**（完全匹配 669 + known_issue 3 + gap_extension 4，无非预期差异；vitro_better 已清零）
