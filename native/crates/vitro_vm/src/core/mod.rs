...
pub use state::{
    AccessType, ArrayConstructionGuard, CallFrame, VitroVM, FreedRegionInfo, StepResult, VariableAccess, GLOBAL_START,
...
pub use state::{FuncMeta, VMSymbol, MAX_FUNCTIONS};
